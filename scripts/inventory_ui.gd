...
const ITENS_DE_RECURSO := [
    ...
    ["alma_eco_do", "Alma do Eco de Dó", "item/gema_roxa", "Épico", "material", "Essência rara necessária para futuramente invocar o Eco de Dó."],
    ["alma_eco_do_sustenido", "Alma do Eco de Dó#", "item/gema_roxa", "Épico", "material", "Essência rara de um Eco de Dó sustenido."],
    ["alma_eco_re", "Alma do Eco de Ré", "item/gema_roxa", "Épico", "material", "Essência rara de um Eco de Ré."],
    ["alma_eco_re_sustenido", "Alma do Eco de Ré#", "item/gema_roxa", "Épico", "material", "Essência rara de um Eco de Ré sustenido."],
    ["alma_eco_mi", "Alma do Eco de Mi", "item/gema_roxa", "Épico", "material", "Essência rara de um Eco de Mi."],
    ["alma_eco_fa", "Alma do Eco de Fá", "item/gema_roxa", "Épico", "material", "Essência rara de um Eco de Fá."],
    ["alma_eco_fa_sustenido", "Alma do Eco de Fá#", "item/gema_roxa", "Épico", "material", "Essência rara de um Eco de Fá sustenido."],
    ["alma_eco_sol", "Alma do Eco de Sol", "item/gema_roxa", "Épico", "material", "Essência rara de um Eco de Sol."],
    ["alma_eco_sol_sustenido", "Alma do Eco de Sol#", "item/gema_roxa", "Épico", "material", "Essência rara de um Eco de Sol sustenido."],
    ["alma_eco_la", "Alma do Eco de Lá", "item/gema_roxa", "Épico", "material", "Essência rara de um Eco de Lá."],
    ["alma_eco_la_sustenido", "Alma do Eco de Lá#", "item/gema_roxa", "Épico", "material", "Essência rara de um Eco de Lá sustenido."],
    ["alma_eco_si", "Alma do Eco de Si", "item/gema_roxa", "Lendário", "material", "Essência rara de um Eco de Si."],
